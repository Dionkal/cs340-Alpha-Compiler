...
typedef struct symTableEntry{
	...
	std::string*	arguments;		//List of arguments passed in the function (only for functions)
...
void insertSym(std::string key,symTableType type,std::string* args,int scp,unsigned int line);
